  ...
  return (
    <section className="bg-white dark:bg-gray-900" id="about">
      <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mx-auto place-self-center col-span-12 animate__animated animate__fadeInLeft">
          <h2 className="max-w-full text-center mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">
            Hi, 👋
          ...
          <p className="max-w-6xl text-center mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
